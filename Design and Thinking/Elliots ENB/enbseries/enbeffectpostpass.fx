...
// Post Process file for TKV ENB SE by GROUPIDEALT      //
//+++++++++++++++++++++++++++++++++++++++++++++++++++++//
...
technique11 BlurSharp <string UIName="TKV WITH SMAA";>  /// First  Blur Pass
{
  pass p0
  {
...
technique11 tkvi <string UIName="TKV WITHOUT SMAA";>  /// First  Blur Pass
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_PostProcess()));
...
technique11 tkvi1  /// Second Blur Pass
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_PostProcess()));
...
technique11 tkvi2  /// First Sharpening Pass
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_PostProcess()));
...
technique11 tkvi3  /// Post effects
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_PostProcess()));
